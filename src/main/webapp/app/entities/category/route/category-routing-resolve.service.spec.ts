  ...
  describe('Category routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return ICategory returned by find', () => {
        // GIVEN
        service.find = jest.fn(idCategory => of(new HttpResponse({ body: { idCategory } })));
        mockActivatedRouteSnapshot.params = { idCategory: 123 };
        ...
        expect(resultCategory).toEqual({ idCategory: 123 });
      });
