  ...
  describe('Product routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return IProduct returned by find', () => {
        // GIVEN
        service.find = jest.fn(idProduct => of(new HttpResponse({ body: { idProduct } })));
        mockActivatedRouteSnapshot.params = { idProduct: 123 };
        ...
        expect(resultProduct).toEqual({ idProduct: 123 });
      });
