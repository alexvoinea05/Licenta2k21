...
export class ProductUpdateComponent implements OnInit {
  ...
  protected updateForm(product: IProduct): void {
    ...
    this.appUsersSharedCollection = this.appUserService.addAppUserToCollectionIfMissing(this.appUsersSharedCollection, product.idGrower);
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.appUserService
      ...
      .pipe(
        map((appUsers: IAppUser[]) => this.appUserService.addAppUserToCollectionIfMissing(appUsers, this.editForm.get('idGrower')!.value))
      )
  ...
  protected createFromForm(): IProduct {
    return {
      ...
      idGrower: this.editForm.get(['idGrower'])!.value,
    };
  }
}
